...
**ファイル**: app/lib/servicename/roadmap/progressCalculator.ts:18
...
- **関連ドキュメント**:
  - [TDD_WORK_FLOW.md](../../develop/servicename/roadmap/TDD_WORK_FLOW.md)
...
**発生箇所**:
app/lib/servicename/roadmap/stepStatusEvaluator.ts:25
...
2. **[TDD_WORK_FLOW.md](../../develop/servicename/*/TDD_WORK_FLOW.md)** - テスト戦略のため
