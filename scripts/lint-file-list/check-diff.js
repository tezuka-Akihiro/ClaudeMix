 ...
 * Example: node scripts/lint-file-list/check-diff.js develop/service-name/implementation-flow/
 */
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.error('');
    console.error('例:');
    console.error('  node scripts/lint-file-list/check-diff.js develop/service-name/implementation-flow/');
    process.exit(1);
  }
  ...
  // 例: develop/service-name/implementation-flow/ → service: service-name, section: implementation-flow
