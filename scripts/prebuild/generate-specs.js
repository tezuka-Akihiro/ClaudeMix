...
/**
 * プリビルドスクリプト: 疎結合・3段階マージ・重複排除スペック生成
 */
...
/**
 * 差分抽出 (sourceからtargetに含まれる共通部分を引いたもの)
 */
...
`;
  ...
  console.log(`   ✅ Generated: ${subPath}.ts`);
}

async function main() {
  console.log('🚀 Starting Advanced Specs Generation...');
...
`;
  ...
  console.log('\n✨ Advanced Specs Generation Completed!');
}
