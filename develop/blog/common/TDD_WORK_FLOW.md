...
- **1. E2Eテストの準備**:
  - **`common`セクションの場合**: 画面レベルのE2Eテストファイル `tests/e2e/blog/common.spec.ts` を**新規作成**します。
...
- Phase 1で作成したE2Eテストファイル: `tests/e2e/blog/common.spec.ts`
...
| 2025-11-14 | Phase 1: E2Eファースト | E2Eテスト作成完了（tests/e2e/blog/common.spec.ts） | Phase 2: CSS実装 |
...
| 2025-11-17 | E2Eテスト実施 | E2Eテスト（tests/e2e/blog/common.spec.ts）全パス確認 | commonセクション完了 ✅ |
